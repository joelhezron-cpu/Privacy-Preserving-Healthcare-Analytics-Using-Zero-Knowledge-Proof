function varargout = SDD(varargin)
% SDD MATLAB code for SDD.fig
%      SDD, by itself, creates a new SDD or raises the existing
%      singleton*.
%
%      H = SDD returns the handle to a new SDD or the handle to
%      the existing singleton*.
%
%      SDD('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SDD.M with the given input arguments.
%
%      SDD('Property','Value',...) creates a new SDD or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SDD_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SDD_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SDD

% Last Modified by GUIDE v2.5 04-Jan-2026 11:06:44

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SDD_OpeningFcn, ...
                   'gui_OutputFcn',  @SDD_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SDD is made visible.
function SDD_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SDD (see VARARGIN)

% Choose default command line output for SDD
...
% UIWAIT makes SDD wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SDD_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global a;global skw;global ad;global m;global L;global me;
...
axes(handles.axes2); imshow(K);title('Preprocessed Image');
